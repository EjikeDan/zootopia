...
public class FXMLController implements Initializable {
    ...
    void menu (ActionEvent event){
      try {
         ...
         AnchorPane root9 = FXMLLoader.load(getClass().getResource("/finalyear/FXML.fxml"));
...
//        stage.show();
  ...
  void next (ActionEvent event){
      try {
          ...
          AnchorPane root9 = FXMLLoader.load(getClass().getResource("/finalyear/Reptiles/FXML1.fxml"));
        Scene scene = new Scene(root9);
        Stage stage = (Stage) this.root9.getScene().getWindow();
        stage.setScene(scene);
...
//          System.out.println("Hello World!");
//          
//          URL url = new File("src/finalyear/Reptiles/FXML1.fxml").toURI().toURL();
//          root1 = FXMLLoader.load(url);
//          
//       // Parent root = FXMLLoader.load(getClass().getResource("src/finalyear/FXML1.fxml"));
//        Scene scene = new Scene(root1);
