...
//        stage.show();
    ...
    void next (ActionEvent event) {
        ...
        try{  
            ...
            AnchorPane root1 = FXMLLoader.load(getClass().getResource("/finalyear/Mammals/FXML4.fxml"));
        Scene scene = new Scene(root1);
        Stage stage = (Stage) this.root1.getScene().getWindow();
        stage.setScene(scene);
            
//         System.out.println("Hello World!");
//         URL url = new File("src/finalyear/Mammals/FXML4.fxml").toURI().toURL();
//          root = FXMLLoader.load(url);
//        Scene scene = new Scene(root);
//        
//        Stage stage = new Stage();
...
//        stage.show();
    ...
    MediaPlayer audio = new MediaPlayer( new Media (new File("src/finalyear/Mammals/rhino.mp3").toURI().toString()));
    audio.play();
    }
