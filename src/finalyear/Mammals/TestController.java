...
private AnchorPane root3;
  ...
  void gb (ActionEvent event){
      try {
          ...
          AnchorPane root3 = FXMLLoader.load(getClass().getResource("/finalyear/Mammals/FXML1.fxml"));
...
//        stage.show();
    ...
    void next (ActionEvent event){
      try {
          ...
          AnchorPane root3 = FXMLLoader.load(getClass().getResource("/finalyear/Mammals/Test1.fxml"));
        Scene scene = new Scene(root3);
        Stage stage = (Stage) this.root3.getScene().getWindow();
        stage.setScene(scene);
