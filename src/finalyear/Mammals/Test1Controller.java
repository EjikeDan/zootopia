...
//        stage.show();
    ...
    void next (ActionEvent event){
      try {
          ...
          AnchorPane root4 = FXMLLoader.load(getClass().getResource("/finalyear/Mammals/Test2.fxml"));
...
//          System.out.println("Hello World!");
//          
//          URL url = new File("src/finalyear/Mammals/Test2.fxml").toURI().toURL();
//          root1 = FXMLLoader.load(url);
//          
//       // Parent root = FXMLLoader.load(getClass().getResource("src/finalyear/FXML1.fxml"));
//        Scene scene = new Scene(root1);
...
//        stage.show();
    ...
    void previous (ActionEvent event){
      try {
                    ...
                    AnchorPane root4 = FXMLLoader.load(getClass().getResource("/finalyear/Mammals/Test.fxml"));
        Scene scene = new Scene(root4);
        Stage stage = (Stage) this.root4.getScene().getWindow();
        stage.setScene(scene);
